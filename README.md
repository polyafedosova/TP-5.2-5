...
# Архитектура
Мобильное приложение основано на трехуровневой архитектуре (клиент - сервер - база данных), которая обеспечивает взаимодействие между клиентской и серверной частями приложения.
Клиентская часть приложения реализовывалась с использованием паттерна Single Activity.
